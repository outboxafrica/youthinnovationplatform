...
class Innovation(models.Model):
    ...
    yr_1_projected_earnings = models.CharField(max_length=50)
    yr_2_projected_earnings = models.CharField(max_length=50)
    yr_3_projected_earnings = models.CharField(max_length=50)
